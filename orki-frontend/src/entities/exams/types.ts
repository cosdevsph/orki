...
export type FirestoreExamAttemptInput = {
  ...
  /**
   * Auto-generated by saveExamAttempt — which retake this is for the same
   * user / exam_type / subject combination (1 = first attempt, 2 = first
   * retake, etc.).  Undefined for attempts saved before this field was added.
   */
  attempt_number?: number;
  /**
   * Auto-generated by saveExamAttempt — deterministic, URL-safe identifier.
   * Format: "{userId}_{examType}_{sanitizedSubject}_{attemptNumber}"
   * Example: "1iwucGlq82gzLqaondYsUxGQa702_pmle_abnormalpsychology_3"
   * Undefined for attempts saved before this field was added.
   */
  attempt_id?: string;
};
